...
function getHourMinuteSecond(iso)
{
...
var server = http.createServer(function (req, res) {
  ...
  {  	
  	...
  	res.write(JSON.stringify(getHourMinuteSecond(urlParsed.query.iso)));
  	res.end();
  }
  else if(urlParsed.pathname == '/api/unixtime')
  {  	
  	res.writeHead(200, { 'Content-Type': 'application/json' });
  	res.write(JSON.stringify(getUnixTime(urlParsed.query.iso)));
  	res.end();
  }
...
# LEARN YOU THE NODE.JS FOR MUCH WIN!
 ...
 ## HINTS
  ...
  here:
  file://C:\Users\juanvargas\AppData\Roaming\npm\node_modules\learnyounode\n
  ode_apidoc\url.html
